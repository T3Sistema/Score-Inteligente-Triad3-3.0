...
const NeuroMapaQuestionnairePage: React.FC = () => {
    const { currentUser, neuroCategories, neuroQuestions, addNeuroMapaSubmission, neuroAnalysisResults, companyNeuroAnalysisResults } = useApp();
        ...
        return (
            <div className="max-w-3xl mx-auto">
                ...
                {availableCategories.length > 0 ? (
                    ...
                    <p className="text-center p-8 bg-dark-card rounded-xl shadow-md border border-dark-border">Você completou todos os questionários do NeuroMapa disponíveis para você. Obrigado!</p>
                )}
            </div>
        );
    }
